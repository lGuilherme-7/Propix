  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    body::before {
      ...
      inset: 0;
      background:
        radial-gradient(ellipse 60% 50% at 70% 15%, rgba(124,58,237,0.07) 0%, transparent 70%),
        radial-gradient(ellipse 40% 40% at 15% 85%, rgba(167,139,250,0.06) 0%, transparent 60%);
      pointer-events: none;
    }
...
<div class="card" id="card">
  ...
  <p class="rodape">Não tem conta? <a href="cadastro.php">Criar conta grátis</a></p>
...
<script>
  ...
  toggleSenha.addEventListener('click', () => {
    ...
    iconeOlho.innerHTML = visivel ? SVG_ABERTO : SVG_FECHADO;
  });
